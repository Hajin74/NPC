...
function scene:create( event )
	...
	person[1] = display.newImageRect("img/mperson1.png", 200, 205)
	person[2] = display.newImageRect("img/mperson2.png", 200, 205)
	person[3] = display.newImageRect("img/mperson3.png", 200, 205)
	for i = 1, 3, 1 do 
