...
function scene:create( event )
	...
	-- 김밥종류
	orderUI[4] = display.newText("꼬마김밥 하나 되죠?", 850, 220, "굴림")
	orderUI[4].size = 30
	orderUI[4]:setFillColor(0)
	orderUI[5] = display.newText("음...\n김치로 주세요.", 850, 220, "굴림")
	orderUI[5].size = 30
    orderUI[5]:setFillColor(0)
	orderUI[6] = display.newText("고양이랑 같이 먹게\n참치김밥 주세요.", 850, 220, "굴림")
	orderUI[6].size = 30
	orderUI[6]:setFillColor(0)
	orderUI[7] = display.newText("쫄깃한 새우김밥 \n하나 부탁드려요!", 850, 220, "굴림")
	orderUI[7].size = 30
	...
	timer.performWithDelay(1700, hp, 31)
